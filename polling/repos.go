...
// StartRepositoryPolling begins a background loop to sync GitLab projects into the database.
func StartRepositoryPolling(db *gorm.DB, client *gitlab.Client, interval time.Duration) {
